        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 glass-panel p-6 rounded-2xl border border-slate-800">
          <div>
            <div className="flex items-center gap-2 text-emerald-400 text-xs font-semibold uppercase tracking-wider mb-1">
              <ShoppingCart className="w-3.5 h-3.5" /> Household Shopping
            </div>
            <h1 className="text-2xl font-bold text-white tracking-tight">Shared Smart Grocery List</h1>
            <p className="text-sm text-slate-400 mt-1">Real-time collaborative grocery shopping list for your household</p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            {purchasedCount > 0 && (
              <button
                ...
                className="bg-teal-500/20 hover:bg-teal-500/30 text-teal-300 border border-teal-500/30 text-xs font-semibold px-4 py-2.5 rounded-xl transition-all flex items-center gap-2"
              >
